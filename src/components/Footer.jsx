  ...
  return (
    ...
    >
      <h1 className="font-bold pl-4  " >
        <span className="text-orange-400">S</span>aurav Chaurasia
      </h1>

      <div className="pr-4" >
        <div className="flex items-center gap-4">

          <div onClick={() => window.open("https://www.instagram.com/saurav_8.4ya/", "_blank")} className="social-button">
          ...
          <div onClick={()=>window.open('https://github.com/saurav84ya/', '_blank')} className="social-button">
            <button className="relative w-12 h-12 rounded-full group">
              <div className="floater w-full h-full absolute top-0 left-0 border-2 border-white bg-black rounded-full duration-300 group-hover:-top-8 group-hover:shadow-2xl"></div>
          ...
          <div onClick={()=>window.open('https://www.linkedin.com/in/saurav-chaurasia-1017192b8/', '_blank')} className="social-button">
            <button className="relative w-12 h-12 rounded-full group">
              ...
              <div className="icon relative z-10 w-full h-full flex items-center justify-center border-2 border-blue-500 rounded-full">
                ...
                >
                  <path
                    className="group-hover:fill-[whitw] fill-white duration-300"
