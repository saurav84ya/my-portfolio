...
export default function Portfolio() {
  return (
    <div className='text-white bg-gradient-to-b from-[#0C0713] to-[#381a5f] py-18 pt-40 pb-[50px]' id="portfolio">
        ...
        <div  className='max-w-[1100px] mx-auto space-y-24 ' >
            {
                projects.map((p,i) => (
                    <motion.div
                        ...
                        className={`flex  ${i % 2 === 1 ? "flex-col-reverse lg:flex-row-reverse gap-12" : "flex-col lg:flex-row" } `}
                    >
                        <div className='space-y-2 max-w-[550px] px-4 md:px-8 ' >
                            ...
                            <div  className='flex gap-2'>  {
                                    p.devstck.map((li,i) => (
                                        <p key={i} className='xl:text-xl text-orange-500 font-semibold ' >
                                           <span className='text-green-400' >#</span>{li}
                                        </p>
                                    ))
                            } </div>
                            <div className='w-64 h-[1px] bg-gray-400 my-4 ' >
                            <a href={p.link} className='mr-6' target="_blank" rel="noopener noreferrer">Link</a>
<a href={p.git} className='mr-6' target="_blank" rel="noopener noreferrer">Git</a>

                            </div>
                        </div>

                        <div className='flex justify-center items-center' >
                            <img src={p.src} alt="img" className='xl:h-[350px] h-[300px] mt-14 lg:mt-0 rounded-lg   w-auto object-cover '  />
                        </div>
                    </motion.div>
                ))
            }
